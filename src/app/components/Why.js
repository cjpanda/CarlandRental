    ...
    <section className="section flex items-center " id="why">
      <div className="container mx-auto">
        ...
        >
          ...
          the competition. From the moment yoy engage with us, we strive to
          exceed you expectation in every interaction.
        </motion.p>
        {/* Car Image */}
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0 ">
            ...
            <p className="hidden xl:flex">
              We prioritizeyour need and we go above and beyond to ensure your
