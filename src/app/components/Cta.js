  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <div className="flex-col flex md:flex-row xl:items-center">
          {/* Text */}
          <div className="flex-1 xl:ml-24 text-center md:text-left mb-12 md:mb-0">
            <div className="max-w-[520px] mx-auto order-2 xl:order-none ">
              ...
              <motion.p
                ...
                className="mb-10"
              >
                Tempor ea labore occaecat esse tempor. Ex id sunt proident
                officia reprehenderit deserunt duis commodo minim proident id
                ullamco commodo. Dolor deserunt est dolor minim sit. Laboris
                incididunt cillum ut irure culpa aute laboris nulla.
              </motion.p>
              {/* Buttons */}
              <motion.div
